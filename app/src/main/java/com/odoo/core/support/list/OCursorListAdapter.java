...
public class OCursorListAdapter extends CursorAdapter implements
    ...
    public interface OnRowViewClickListener {
        void onRowViewClick(int position, Cursor cursor, View view,
                            View parent);
    }

    public interface OnViewBindListener {
        void onViewBind(View view, Cursor cursor, ODataRow row);
    }

    public interface BeforeBindUpdateData {
        ODataRow updateDataRow(Cursor cr);
    }

    public interface OnViewCreateListener {
        View onViewCreated(Context context, ViewGroup view, Cursor cr,
                           int position);
    }
